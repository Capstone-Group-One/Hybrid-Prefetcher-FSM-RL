...
extern uint64_t fsm_reward_at;
extern uint64_t fsm_reward_in;
...
//         uncore.LLC.llc_prefetcher_final_stats();
    ...
    // FSM + RL Hybrid Statistics
    
    std::cout << "FSM_Prefetches: " << fsm_prefetch_count << std::endl;
    std::cout << "FSM_Covered:    " << fsm_reward_at << std::endl;
    std::cout << "FSM_Pollution:  " << fsm_reward_in << std::endl;
    std::cout << "Classification_Table_Size: " << classification_table.size() << std::endl;
